...
<title>메론바나나우유: 해당 접속이 원활하지 않습니다.</title>
...
<div id="wrap">
    <div id="header">
        ...
        <p class="menu"><a href="http://www.naver.com/">아라홈</a> | <a onclick="window.open('https://help.naver.com/support/alias/contents2/naverhome/notfound.naver', 'help_naver', 'left=40,top=60,width=650,height=800,toolbar=1,resizable=0'); return false;">네이버 고객센터</a></p>
    </div>
    <div id="container">
